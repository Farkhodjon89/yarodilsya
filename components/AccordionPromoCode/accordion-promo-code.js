  ...
  return (
      <>
        <Accordion>
          ...
          >
            <Typography
                sx={{fontWeight: 600, fontSize: {xs: '13px', md: '17px'}, color: 'btn.main'}}>Промокод</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Box sx={{width: 'inherit', display: 'flex', justifyContent: 'space-between'}}>
              <Box sx={{width: '65%'}}>
                <TextField id='name'
        ...
        <Accordion>
          <AccordionSummary
              ...
              id="panel1a-header"
          >
            <Typography sx={{fontWeight: 600, fontSize: {xs: '13px', md: '17px'}, color: 'btn.main'}}>
          ...
          <AccordionDetails>
            ...
            <Typography sx={{fontWeight: 400, lineHeight: '19px', fontSize: '14px', color: 'grey.main'}}>
            ...
            <Paper sx={{
              ...
              <Typography sx={{color: 'white.main', fontSize: '14px', fontWeight: 500}}>
